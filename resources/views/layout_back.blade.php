  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="{{ route("contenu.edit", ['slug' => 'equipe-pedagogique']) }}">Equipe pédagogique</a></li>
          <li><a href="{{ route("contenu.edit", ['slug' => 'ecole-de-tennis']) }}">Ecole de tennis</a></li>
...
$(function () {
  ...
  CKEDITOR.replace('editor',{fileBrowserBrowseUrl : '/elfdsinder/ckeditor'});
